...
<p>Install from npm or download a standalone binary. Works on macOS and Linux, ARM and x64.</p>
<div class="terminal">
...
<pre><span class="dim">$</span> <span class="cmd">npm install -g tunn3l</span>
<span class="ok">added 2 packages</span>
...
function renderNoKey() {
  app.innerHTML = '<div id="no-key"><h1><a href="/" style="color:inherit;text-decoration:none">tunn3l<span style="color:#a8a29e">.sh</span></a></h1><p style="color:#a8a29e;margin:8px 0 24px">Enter your API key to manage your tunnels.</p><input type="text" placeholder="tk_..." id="key-input"><p style="font-size:.75rem;color:#a8a29e;margin-top:16px">Install tunn3l to get a key: <code>npm install -g tunn3l</code></p></div>'
...
<div class="cmd">$ npm install -g tunn3l</div>
<div class="ok">added 2 packages</div>
<div>&nbsp;</div>
...
<h3>Zero setup</h3>
<p>No account. No API key. No client app on the other end. Just <code style="background:rgba(255,255,255,0.08);padding:2px 6px;border-radius:4px">npm install -g tunn3l</code> and go. Unlike Tailscale or Cloudflare Tunnel, nothing needed on either side.</p>
</div>
<div class="feature">
...
<div class="footer">
<span>tunn3l.sh is <a href="https://github.com/bdecrem/tunn3l" target="_blank">open source</a></span>
<a href="https://github.com/bdecrem/tunn3l/issues/new?title=Feature+request:+" target="_blank">Request a feature</a>
<a href="https://github.com/bdecrem/tunn3l" target="_blank">GitHub</a>
</div>
</div>
</body>
</html>`)
